...
public class PetsCrudWithSteps extends TestBase {

    static int id = getRandomDigits();
    static String Name = "BabyDog";
    ...
    @Test
    public void test001() {
        PetBodyDataPojo.CategoryData categoryData = new PetBodyDataPojo.CategoryData(getRandomDigits(), "BabyDog");
